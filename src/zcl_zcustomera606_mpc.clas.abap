class ZCL_ZCUSTOMERA606_MPC definition
  public
...
public section.
  ...
  types:
     TS_CUSTOMER type ZCUST606 .
  types:
TT_CUSTOMER type standard table of TS_CUSTOMER .
  types:
     TS_ADDRESS type ZCUSTADDRESS606 .
  types:
TT_ADDRESS type standard table of TS_ADDRESS .
  types:
     TS_USER type ZCUSTUSER606 .
  types:
TT_USER type standard table of TS_USER .
  types:
     TS_ATTEND type ZCUSTATTEND606 .
  types:
TT_ATTEND type standard table of TS_ATTEND .

  constants GC_ADDRESS type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Address' ##NO_TEXT.
  constants GC_ATTEND type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Attend' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZCUSTOMERA606_MPC=========CP' ##NO_TEXT.
...
CLASS ZCL_ZCUSTOMERA606_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZCUSTOMERA606_SRV' ).
...
lo_property = lo_entity_type->create_property( iv_property_name = 'AddressId' iv_abap_fieldname = 'ADDRESS_ID' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Complement' iv_abap_fieldname = 'COMPLEMENT' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Neighborhood' iv_abap_fieldname = 'NEIGHBORHOOD' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZCUSTADDRESS606'
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'BirthDate' iv_abap_fieldname = 'BIRTH_DATE' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZCUST606'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20240331015821'.                  "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'PostCode'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Address'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Complement'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Address'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Neighborhood'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Address'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'TypeId'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'User'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'AttendanceId'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Attend'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'Password'    iv_abap_fieldname = 'PASSWORD' ). "#EC NOTEXT
lo_parameter->set_label_from_text_element( iv_text_element_symbol = '023' iv_text_element_container = gc_incl_name ). "#EC NOTEXT
...
lo_parameter->/iwbep/if_mgw_odata_property~set_type_edm_string( ).
lo_action->bind_input_structure( iv_structure_name  = 'ZCL_ZCUSTOMERA606_MPC=>TS_LOGIN' ). "#EC NOTEXT
  endmethod.
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'CustomerToAddress' "#EC NOTEXT
                            iv_left_type        = 'Customer' "#EC NOTEXT
                            iv_right_type       = 'Address' "#EC NOTEXT
                            iv_right_card       = '1' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_true ). "#EC NOTEXT
 lo_association = model->create_association(
                            iv_association_name = 'CustomerToUser' "#EC NOTEXT
                            iv_left_type        = 'Customer' "#EC NOTEXT
                            iv_right_type       = 'User' "#EC NOTEXT
                            iv_right_card       = '1' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_true ). "#EC NOTEXT
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'address' "#EC NOTEXT
                                                              iv_abap_fieldname = 'TOADDRESS' "#EC NOTEXT
                                                              iv_association_name = 'CustomerToAddress' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'user' "#EC NOTEXT
                                                              iv_abap_fieldname = 'TOUSER' "#EC NOTEXT
                                                              iv_association_name = 'CustomerToUser' ). "#EC NOTEXT
  endmethod.


  method DEFINE_ATTEND.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Attend' iv_def_entity_set = abap_false ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************

lo_property = lo_entity_type->create_property( iv_property_name = 'AttendanceId' iv_abap_fieldname = 'ATTENDANCE_ID' ). "#EC NOTEXT
...
lo_property->set_semantic( '0' ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
lo_property->set_nullable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZCUSTATTEND606'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'AttendSet' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'TypeId' iv_abap_fieldname = 'TYPE_ID' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZCUSTUSER606'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
